...
{
    glDrawElements(GL_TRIANGLES, count, GL_UNSIGNED_INT, (const unsigned int *)buffer + offset);
}
...
{
#if defined(GRAPHICS_API_OPENGL_33) || defined(GRAPHICS_API_OPENGL_ES2)
    glDrawElementsInstanced(GL_TRIANGLES, count, GL_UNSIGNED_INT, (const unsigned int *)buffer + offset, instances);
#endif
}
